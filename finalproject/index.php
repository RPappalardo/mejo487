  ...
  <div class="w3-content w3-container w3-padding-64" id="about">
    ...
    <div class="w3-row">
      <div class="w3-col m6 w3-center w3-padding-large">
        ...
        <div id="tweets" width="500" height="333" style ="overflow:auto;border:8px solid yellowgreen;padding:2%">
          <?php
           ...
           'oauth_access_token' => "702336877408468992-Lxmaj1s5oVS2u7N5R0X4eWLNaftXiq8",
            ...
            foreach($tweetData['statuses'] as $index => $items){
              ...
              echo '<div class="tweet"><a href="https://twitter.com/' . $userArray['screen_name'] . '"><img class="img-circle" src="'. $userArray['profile_image_url'] . '"></a></div>';
              // echo $items['text']. "<br />";
